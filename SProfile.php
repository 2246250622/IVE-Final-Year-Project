...
require("conn.php");
 ...
 $sql="select * from staff where S_Email = '".$_SESSION['email']."'";
...
?>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text"  class="form-control form-control-line" name="fname" value="<?php echo $row['S_Name']; ?>" required> </div>
                            </div>				
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="password"  class="form-control form-control-line" name="password" value="<?php echo $row['S_Password']; ?>" required> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Phone No</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="12345678" class="form-control form-control-line" name="PhoneNo" value="<?php echo $row['S_Phone']; ?>" required> </div>
                            </div>       
