      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Cancel Book Date</li>
          </ol>
         ...
         <div class="row">                
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form class="form-horizontal form-material" method="post" action="deleteBookDate.php">
<?php
require("conn.php");
...
?>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-success" type="sumbit" name="submit">Cancel Date</button>
                                </div>
                            </div>
                        </form>
						<?php
...
if (isset($uids)){
	$sql3="SELECT * FROM booking_order WHERE U_ID='".$uids."'";
	...
	if ($tt>0){
		echo 'Your booking date detail: <span style="color:red">'.$dts.'</span><br>';
		echo 'If you want to cancel your previous booking, please click the \'Cancel Date\' button.';
	}else{
		echo 'Your booking date detail is empty.';
	}
}
