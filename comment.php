      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Comment Area</li>
          </ol>

          <!-- Page Content -->


  <h2 align="center"><a href="#">COVID-19 Online System</a></h2>
   <h3 align="center"><a href="#">Comment Area</a></h3>
  <br />
  <div class="container">
   <form method="POST" id="comment_form">
    ...
    <div class="form-group">
     <input type="text" name="comment_name" id="comment_name" class="form-control" value="<?php echo $_SESSION['email'];  ?> (user)"readonly />
    </div>
    <div class="form-group">
