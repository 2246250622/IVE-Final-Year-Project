        ...
        <div class="container-fluid">
         ...
         <div class="row">                
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form class="form-horizontal form-material" method="post" action="profileAhelper.php">
<?php
require("conn.php");

 $sql="select * from admins where A_Email = '".$_SESSION['email']."'";
...
?>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text"  class="form-control form-control-line" name="fname" value="<?php echo $row['A_Name']; ?>" required> </div>
                            </div>				
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Email</label>
                                <div class="col-md-12">
                                    <input type="email" class="form-control form-control-line" name="email" id="example-email" readonly="true" value="<?php echo $row['A_Email']; ?>"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Password</label>
                                <div class="col-md-12">
                                    <input type="password"  class="form-control form-control-line" name="password" value="<?php echo $row['A_Password']; ?>" required> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Phone No</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="12345678" class="form-control form-control-line" name="PhoneNo" value="<?php echo $row['A_Phone']; ?>" required> </div>
                            </div>       
